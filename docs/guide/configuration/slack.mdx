...
![slack-token](/images/slack-token.png "Slack Token")
![slack-scope](/images/slack-scope.png "Slack Scope")
...
![slack-channel-id](/images/slack-channel-id.png "Slack Channel ID")

## 5. Configure EMQX-Guard-Pro Plugin
```shell
...
```
![slack-notification](/images/slack-send-channel-message.png "Slack Notification")
